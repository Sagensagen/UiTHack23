  ...
  return (
	...
	<div className='formContainer'>
		...
		<div className="field" tabindex="1">
			...
			<input name="email" type="text" placeholder="email@domain.com"  value={email} onChange={(e) => setEmail(e.target.value)} required/>
		</div>
		<div className="field" tabindex="1">
			<label for="message">
				<i className="far fa-edit"></i>Your Message
			</label>
			<textarea name="message" placeholder="type here" value={complaint} onChange={(e) => setComplaint(e.target.value)} required></textarea>
		</div>
		<button type="reset" onClick={sendComplaint}>Send Me Message</button>
